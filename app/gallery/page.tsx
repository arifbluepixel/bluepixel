...
export const metadata = generateMetadata({
  ...
  description:
    "Explore the BluePixel photo gallery showcasing our apparel manufacturing excellence. Discover our latest collections, production facilities, fabric sourcing, and behind-the-scenes visuals that highlight our commitment to quality, craftsmanship, and sustainable garment production.",
  keywords:
